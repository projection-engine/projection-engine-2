#ifndef PROJECTION_PRIMITIVEUTIL_H
#define PROJECTION_PRIMITIVEUTIL_H

#include <vector>

namespace PEngine {

    struct PrimitiveUtil {
        static std::vector<float> ComputeNormals(std::vector<float> indices, std::vector<float> vertices);
...
//            }
//
        static std::vector<float> ComputeTangents(std::vector<float> indices,
...
//            }
//
        static std::vector<float> ComputeBoundingBox(std::vector<float> vertices);
