    ...
    initialize() {
        ...
        this.group(LocalizationEN.RENDERING, t => {
            t.group(LocalizationEN.RESOLUTION, st => {
                ...
                st.number(LocalizationEN.HEIGHT, "resolutionY", undefined, 1, 1)
            })
            t.group(LocalizationEN.ANTI_ALIASING, st => {
                st.boolean(LocalizationEN.FXAA, "FXAA" )
                st.boolean(LocalizationEN.TAA, "TAA", _ => true)
            })

            t.group(LocalizationEN.PHYSICS, st => {
            ...
            t.group(LocalizationEN.SSGI, st => {
            ...
            t.group(LocalizationEN.DIRECTIONAL_SHADOWS, st => {
                st.number(LocalizationEN.MAX_LIGHTS, "shadowAtlasQuantity", undefined, 1, 1)
            })

            t.group(LocalizationEN.SSAO, st => {
